<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_development_view|template/default/header|template/default/space_menu|template/default/space_click|template/default/space_comment_li|template/default/footer', '1370333889', 'template/default/space_development_view');?><?php $_TPL['titles'] = array($development['subject'], '企业动态'); ?>
...
<?php if($space['self']) { ?>
<h2 class="title"><img src="image/app/blog.gif" /><?=$_SN[$space['uid']]?>>企业动态</h2>
...
<div class="title">
<h1<?php if($development['magiccolor']) { ?> class="magiccolor<?=$development['magiccolor']?>"<?php } ?>><?=$development['subject']?></h1>
<a href="cp.php?ac=development" class="r_option" style="padding: 0 5px; height: 24px; border: none; background: #FF8901; color: #FFF; line-height: 20px; letter-spacing: 1px; cursor: pointer; ">发布</a>
<?php if($development['order']) { ?><a href="cp.php?ac=development" class="r_option" style="padding: 0 5px; height: 24px; border: none; background: #FF8901; color: #FFF; line-height: 20px; letter-spacing: 1px; cursor: pointer;margin-right:20px; ">预订/预约</a><?php } ?>
<?php if($development['friend']) { ?>
<span class="r_option locked gray"><?=$friendsname[$development['friend']]?></span>
<?php } ?>
<?php if($development['hot']) { ?><span class="hot"><em>热</em><?=$development['hot']?></span><?php } ?>
<?php if($development['friend']) { ?>
<span class="r_option locked gray">
<a href="space.php?uid=<?=$space['uid']?>&do=<?=$do?>&view=me&friend=<?=$development['friend']?>" class="gray"><?=$friendsname[$value['friend']]?></a>
</span>
<?php } ?>
<?php if($development['viewnum']) { ?><span class="gray">已有 <?=$development['viewnum']?> 次阅读</span><?php } ?>
&nbsp; <span class="gray"><?php echo sgmdate('Y-m-d H:i',$development[dateline],1); ?></span>
<?php if($development['tag']) { ?>
&nbsp; 标签:&nbsp;
<?php if(is_array($development['tag'])) { foreach($development['tag'] as $tagid => $tagname) { ?>
<a href="#"><?=$tagname?></a>&nbsp;&nbsp;
<?php } } ?>
<?php } ?>
<?php if($development['money']) { ?>
|&nbsp;价格:<?=$development['money']?>
<?php } ?>
</div>


<div id="development_article" class="article <?php if($development['magicpaper']) { ?> magicpaper<?=$development['magicpaper']?><?php } ?>">
<div class="resizeimg">
...
<a href="cp.php?ac=development&developmentid=<?=$development['developmentid']?>&op=edit">编辑</a><span class="pipe">|</span>
<a href="cp.php?ac=development&developmentid=<?=$development['developmentid']?>&op=delete" id="blog_delete_<?=$development['developmentid']?>" onclick="ajaxmenu(event, this.id)">删除</a>
<?php } ?>
...
<?php } ?>
评论 (<span id="comment_replynum"><?=$development['replynum']?></span> 个评论)</h2>
