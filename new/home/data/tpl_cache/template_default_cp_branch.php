<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/cp_branch|template/default/header|template/default/cp_topic_menu|template/default/footer|template/default/space_topic_inc', '1369901297', 'template/default/cp_branch');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
...
封面图片:<input type="file" name="file1" value="<?=$branch['image1url']?>"/>
</td>
</tr>
<tr>
<td>正文：
