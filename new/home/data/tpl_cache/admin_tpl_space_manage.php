<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('admin/tpl/space_manage|admin/tpl/header|admin/tpl/side|admin/tpl/footer|template/default/header|template/default/footer', '1370240724', 'admin/tpl/space_manage');?><?php $_TPL['menunames'] = array(
		'index' => '管理首页',
		'config' => '站点设置',
		'privacy' => '隐私设置',
		'usergroup' => '用户组',
...
<th>常用邮箱</th>
<td>
<input type="text" class="t_input" name="email" value="<?=$member['email']?>" /> 
</td>
</tr>
