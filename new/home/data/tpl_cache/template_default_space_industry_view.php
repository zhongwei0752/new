<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_industry_view|template/default/header|template/default/space_menu|template/default/space_click|template/default/space_comment_li|template/default/footer', '1370333899', 'template/default/space_industry_view');?><?php $_TPL['titles'] = array($industry['subject'], '行业动态'); ?>
