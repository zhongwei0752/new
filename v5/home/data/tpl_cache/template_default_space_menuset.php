<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_menuset|template/default/header|template/default/footer', '1373191063', 'template/default/space_menuset');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
...
<ul class="tabs">
<li<?=$actives['me']?>><a href="space.php?do=menuset&view=me"><span>菜单设置</span></a></li>
</ul>
</div>	
请选择要保留的基本组件：
<form action = "space.php?do=check" method = "post">
<?php if(is_array($list)) { foreach($list as $value) { ?>
<input type="checkbox" name="<?=$value['subject']?>" value ="<?=$value['menusetid']?>" ><?=$value['subject']?><br>
