<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_introduce_view|template/default/header|template/default/space_menu|template/default/space_comment_li|template/default/footer', '1374573858', 'template/default/space_introduce_view');?><?php $_TPL['titles'] = array($introduce['subject'], '企业介绍'); ?>
...
<div  style="padding:0 0 10px;">
            ...
            <div class="content" style="font-size:15px;">
            	<div class="indexing" style="margin-bottom:15px;">
                  <span><a href="space.php?do=home">首页</a></span>><span><a href="space.php?do=introduce&view=me">企业介绍</a></span>
                 </div>
                 <div class="content_detail_wrapper">
                      <div class="content_page_detail">
                           <div class="content_title"><?=$introduce['subject']?></div>
                           <div class="content_text_detail" style="text-align: center;margin-bottom:10px;margin-top:10px;font-size:12px;">作者 : <?=$introduce['username']?>&nbsp;|&nbsp;发布时间 : <?php echo sgmdate('Y-m-d H:i:s',$introduce[dateline]); ?></div>
