<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_moblie_view|template/default/header|template/default/space_menu|template/default/space_comment_li|template/default/footer', '1375240064', 'template/default/space_moblie_view');?><?php $_TPL['titles'] = array($moblie['subject'], '手机模版'); ?>
            	...
            	<div class="indexing" style="margin-bottom:15px;">
                 ...
                 <div class="content_detail_wrapper">
                      <div class="content_page_detail">
                           ...
                           <div class="content_text_detail" style="text-align: center;margin-bottom:10px;margin-top:10px;font-size:12px;">作者 : <?=$moblie['username']?>&nbsp;|&nbsp;发布时间 : <?php echo sgmdate('Y-m-d H:i:s',$moblie[dateline]); ?></div>
