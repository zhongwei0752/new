<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_dialog_view|template/default/header|template/default/footer', '1376620609', 'template/default/space_dialog_view');?>
                     ...
                     <div class="content_list container_12">
                          ...
                          <?php if($value['uid'] == $space['uid']) { ?>
                          	...
                          	<div class="bubbleright">
                				...
                				<div class = "bubble">
                          		...
                          		<div class= "bubbleheader bgc1"><?=$space['username']?></div>
                          		<div class = "bubblecontent"><?=$value['message']?></div>
                          		<div class = "bubblefooter"><?=$value['dateline']?></div>
                          		</div>
                          	</div>
                          ...
                          <?php } else { ?>
                          	...
                          	<div class = "bubble">
                          		...
                          		<div class= "bubbleheader bgc2"><?=$ruser['username']?></div>
                          		<div class = "bubblecontent"><?=$value['message']?></div>
                          		<div class = "bubblefooter"><?=$value['dateline']?></div>
                          	</div>
                          	</div>
