<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_dialog_list|template/default/header|template/default/footer', '1377490508', 'template/default/space_dialog_list');?>
...
<?php if(is_array($list)) { foreach($list as $value) { ?>
                     ...
                     <div class="avatar48"><?php echo avatar($value[cid]); ?></div>
                     <div class="pm_body">
                     	<div class = "pm_h">
                     		<div class = "pm_f">
                     			<p>
                     				<a href = "space.php?uid=<?=$value['cid']?>"><?=$value['username']?></a>
                     			...
                     			<p class = "bottom_set">
                     				<a href = "space.php?do=communicate&dialog=<?=$value['dialogid']?>" >查看详情</a>&nbsp;&nbsp;&nbsp;
                          	        <a href = "javascript:void(0);" onclick="quickreply(<?=$space['uid']?>,<?=$value['cid']?>,<?=$value['dialogid']?>)">快速回复</a>
                     			</p>
                     		</div>
                     	</div>
                     </div>
