<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_development_list|template/default/header|template/default/footer', '1370765941', 'template/default/space_development_list');?><?php $_TPL['titles'] = array('企业动态'); ?>
...
<?php } else { ?>
<div class="c_form">还没有相关的企业动态。</div>
<?php } ?>
</div>
<?php } else { ?>
...
<ul class="tabs">
<li<?=$actives['me']?>><a href="space.php?uid=<?=$space['uid']?>&do=<?=$do?>&view=me"><span>企业动态</span></a></li>
<li class="null"  style="margin-left:670px;"><a href="cp.php?ac=development">发布</a></li>
</ul>
</div>		
...
<div class="newavatar48"><a href="space.php?uid=<?=$value['uid']?>"><image src="<?=$value['image1url']?>" /></a></div>
<?php if($value['hot']) { ?><div class="digb"><?=$value['hot']?></div><?php } ?>
</div>
<div id="next" style="margin-left:60px;margin-top:5px;">
<div class="title">

<h4><a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&id=<?=$value['developmentid']?>" <?php if($value['magiccolor']) { ?> class="magiccolor<?=$value['magiccolor']?>"<?php } ?>><?=$value['subject']?></a></h4>
</div>	


<div class="detail image_right l_text" id="blog_article_<?=$value['developmentid']?>">
<?php if($value['pic']) { ?><p class="image"><a href="space.php?uid=<?=$value['uid']?>&do=development&id=<?=$value['developmentid']?>"><img src="<?=$value['pic']?>" alt="<?=$value['subject']?>" /></a></p><?php } ?>
<?=$value['message']?>
</div>
<div class="gray">
...
<?php if($value['viewnum']) { ?><a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&id=<?=$value['developmentid']?>">阅读: <?=$value['viewnum']?>次</a><span class="pipe">|</span><?php } else { ?>阅读: 0次<span class="pipe">|</span><?php } ?>
<?php if($value['replynum']) { ?><a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&id=<?=$value['developmentid']?>#comment">评论: <?=$value['replynum']?> 个</a><?php } else { ?>评论: 0次<?php } ?>
</div>
</div>
</li>
<br/>
