<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_highmenuset_list|template/default/footer', '1377162005', 'template/default/space_highmenuset_list');?><!DOCTYPE html>
<html>
  <head>
    <title>选购应用</title>
  ...
  <body>
    ...
    <div class="wrapper">
        <div class="navbar">
         ...
         <!-- navbar end -->
         <form action = "space.php?do=highmenuset" method = "post">
