<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('./wx/template/goodscontent', '1376463608', './wx/template/goodscontent');?><!DOCTYPE html>
<html>
  <head>
 ...
 <header class="content_header_width">
      ...
      <h3>   <?=BLOCK_TAG_START?>if goods<?=BLOCK_TAG_END?>
                 <p> {{= goods.subject}}</p><span class="price">{{= goods.curprice}}元</span>
       ...
       <div id="detail-panel">
          ...
          <div class="content_text">
            <div class="normal_wrapper_width">
              ...
              <div class="content_text product_content_text">
                  <span style="line-height:28px;">价    格:<b class="price"><?=$wei['curprice']?>元</b></span><br>
                  <span>联系人: <?=$space['linkman']?> </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>电    话: <?=$space['mobile']?></span>
                  <p>
              ...
              <a href="javascript:void;" onclick='gototaobao("<?=$wei['taobaourl']?>")' class="long_btn">购买</a>
             </div>
          </div>
          <div class="split"></div>
