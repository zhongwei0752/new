<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/cp_product|template/default/header|template/default/cp_topic_menu|template/default/footer|template/default/space_topic_inc', '1375265454', 'template/default/cp_product');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
...
<div class="content" style="font-size:15px;">
                 ...
                 <div class="indexing">
                   <span><a href="space.php?do=home">首页</a></span>><span><a href="space.php?do=product&view=me">产品介绍</a></span>><span>发布</span>
                 </div><!-- end -->
...
<div class="post_list container_12">
                         <span class="select_title grid_1">标题&nbsp;&nbsp;:&nbsp;&nbsp;</span>
                           <input type="text" class="t_input" id="subject" name="subject" value="<?=$product['subject']?>"  onblur="relatekw();" placeholder="标题长度不超过80字符" />
                            </div>
                            <div class="post_list container_12">
                         <span class="select_title grid_1">价格&nbsp;&nbsp;:&nbsp;&nbsp;</span>
                           <input type="text" class="t_input"  id="money" name="money" value="<?=$product['money']?>">
                            </div>
                            <div class="post_list container_12">
...
<td>
<div class="post_list container_12">
                         <span class="select_title grid_1">产品介绍&nbsp;&nbsp;:&nbsp;&nbsp;</span>
