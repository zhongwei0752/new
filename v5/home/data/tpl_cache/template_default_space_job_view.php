<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_job_view|template/default/header|template/default/space_menu|template/default/footer', '1375255428', 'template/default/space_job_view');?><?php $_TPL['titles'] = array($job['subject'], '人才招聘'); ?>
...
<div style="padding:0 0 10px;">
            <div class="content" style="font-size:15px;">
                    ...
                    <span><a href="space.php?do=home">首页</a></span>><span><a href="space.php?do=job&view=me">人才招聘</a></span>
                    </div><!-- end -->
                 <div class="content_detail_wrapper">
                 	
                      <div class="content_page_detail">
                           <div class="content_title"><?=$job['subject']?></div>
                         <div class="content_text_detail" style="text-align: center;margin-bottom:10px;margin-top:10px;font-size:12px;">作者 : <?=$job['username']?>&nbsp;|&nbsp;发布时间 : <?php echo sgmdate('Y-m-d H:i:s',$job[dateline]); ?></div>
   ...
   <?php } ?>
                           ...
                           <div class="feed_action">
                              <ul>
                                 ...
                                 <li><a href="cp.php?ac=job&jobid=<?=$job['jobid']?>&op=delete">删除</a></li>
                                 <?php } ?>
                              </ul>
                           </div>
