<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_job_view|template/default/header|template/default/space_menu|template/default/footer', '1373339147', 'template/default/space_job_view');?><?php $_TPL['titles'] = array($job['subject'], '人才招聘'); ?>
...
<div class="entry" style="padding:0 0 10px;">
            <div class="content">
                    <div class="indexing content_indexing">
                       <span><a href=""><?=$_SN[$space['uid']]?></a></span>><span><a href="">人才招聘</a></span>
                    </div><!-- end -->
                 <div class="content_detail_wrapper">
                      <div class="content_page_detail">
                           <div class="content_title"><?=$job['subject']?></div>
                         
                           <div class="advertise_content_text_detail">
                           	   <?php if($job['message']) { ?>
