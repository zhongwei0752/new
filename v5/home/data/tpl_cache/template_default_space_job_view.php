<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_job_view|template/default/header|template/default/space_menu|template/default/footer', '1373428572', 'template/default/space_job_view');?><?php $_TPL['titles'] = array($job['subject'], '人才招聘'); ?>
...
<div class="entry" style="padding:0 0 10px;">
            <div class="content" style="font-size:15px;">
                    <div class="indexing content_indexing">
                       <img src="<?=$wei1['image2url']?>" /><span><a href="space.php?uid=<?=$space['uid']?>"><?=$_SN[$space['uid']]?></a></span>><span><a href="">人才招聘</a></span>
                    </div><!-- end -->
