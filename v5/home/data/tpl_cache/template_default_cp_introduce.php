<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/cp_introduce|template/default/header|template/default/cp_topic_menu|template/default/footer|template/default/space_topic_inc', '1374571308', 'template/default/cp_introduce');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
...
<font color="#02B4AB">*如果企业介绍已经有此分类的内容，则再选择此分类填写的内容会覆盖更新原内容。</font>
                      </div>
<div class="post_list container_12">
