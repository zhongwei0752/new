<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_product_view|template/default/header|template/default/space_menu|template/default/space_comment_li|template/default/footer', '1373202784', 'template/default/space_product_view');?><?php $_TPL['titles'] = array($product['subject'], '产品介绍'); ?>
