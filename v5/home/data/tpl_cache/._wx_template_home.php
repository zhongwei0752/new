<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('./wx/template/home', '1375087454', './wx/template/home');?><!DOCTYPE html>
<html>
  <head>
  	 <title></title>
  	 <meta charset="utf-8">
    ...
    <div data-role="page">
        ...
        <div data-role="content">
             <div class="banner_pic">
                <img src="http://v5.home3d.cn/v5/v5/home/<?=$home1['imageurl']?>">
             </div>
             ...
             <div class="menu_wrapper">
              ...
              <a href="wx.php?do=feed&uid=<?=$_GET['uid']?>&idtype=<?=$value['english']?>">
             	<table class="menu">
                   <tr>
                       <td class="menu_icon">
                           <img src="http://v5.home3d.cn/v5/v5/home/wx/template/img/<?=$value['icon']?>">
                       </td>
                       <td><?=$value['subject']?></td>
                       <td>
