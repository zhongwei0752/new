<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/do_stat|template/default/header|template/default/footer', '1377136272', 'template/default/do_stat');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
...
<li>
<strong>基础数据</strong>：
<a href="do.php?ac=stat"<?=$actives['all']?>>综合概况</a> &nbsp;
<?php if(is_array($cols['login'])) { foreach($cols['login'] as $value) { ?>
<a href="do.php?ac=stat&type=<?=$value?>"<?=$actives[$value]?>><?php echo cplang("do_stat_$value"); ?></a> &nbsp;
<?php } } ?>
</li>
<li>
<strong>信息发布</strong>：
<?php if(is_array($cols['add'])) { foreach($cols['add'] as $value) { ?>
<a href="do.php?ac=stat&type=<?=$value?>"<?=$actives[$value]?>><?php echo cplang("do_stat_$value"); ?></a> &nbsp;
<?php } } ?>
</li>
<li>
<strong>信息互动</strong>：
<?php if(is_array($cols['comment'])) { foreach($cols['comment'] as $value) { ?>
<a href="do.php?ac=stat&type=<?=$value?>"<?=$actives[$value]?>><?php echo cplang("do_stat_$value"); ?></a> &nbsp;
<?php } } ?>
</li>
<li>
<strong>用户互动</strong>：
<?php if(is_array($cols['space'])) { foreach($cols['space'] as $value) { ?>
<a href="do.php?ac=stat&type=<?=$value?>"<?=$actives[$value]?>><?php echo cplang("do_stat_$value"); ?></a> &nbsp;
<?php } } ?>
</li>
</ul>
...
<h2>综合概况</h2>
<p>
这里看到的是站点的综合概况发展统计。(需要至少统计2天后才有效)
</p>
</caption>
<tr><td>
<ul class="line_list">
...
<?php } else { ?>
<caption>
<h2><?php echo cplang("do_stat_$type"); ?></h2>
</caption>
<?php } ?>
<tr><td>
<div class="borderbox">
