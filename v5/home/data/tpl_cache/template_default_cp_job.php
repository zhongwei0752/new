<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/cp_job|template/default/header|template/default/cp_topic_menu|template/default/footer|template/default/space_topic_inc', '1373340359', 'template/default/cp_job');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
...
<div class="content">
                 ...
                 <div class="indexing">
                   <img src="<?=$wei1['image2url']?>" /><span><?=$_SN[$space['uid']]?></span>><span>人才招聘</span>
                 </div><!-- end -->
...
<div class="post_list container_12">
 ...
 <div class="post_list container_12">
                         ...
                         <span class="select_title grid_1">其他&nbsp;&nbsp;:</span>
                          <textarea name="othermessage" style="width:700px;height:200px;margin-left:20px;"><?=$job['othermessage']?></textarea>
                            </div>
