<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_branch_list|template/default/header|template/default/footer', '1374724271', 'template/default/space_branch_list');?><?php $_TPL['titles'] = array('分支机构'); ?>
...
<div class="content" style="font-size:15px;">
                 ...
                 <div class="indexing">
                 <span><a href="space.php?do=home">首页</a></span>><span>分支机构</span>
                 </div><!-- end -->
                             ...
                             <div class="list_test ">
                                  ...
                                  <p class="action_info" style="margin-top:-4px;">
                                   <a href="space.php?uid=<?=$value['uid']?>"> <span>发布：<?=$_SN[$value['uid']]?></span></a>
                                    ...
                                    <?php if($value['replynum']) { ?><a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&id=<?=$value['branchid']?>#comment"><span>评论: <?=$value['replynum']?> 个</span></a><?php } else { ?><span>评论: 0次</span><?php } ?><span>发布日期：<?php echo sgmdate('Y-m-d',$value[dateline]); ?></span>
                                  </p>
                             </div>
                          </div>
                     </div><!-- list end -->
