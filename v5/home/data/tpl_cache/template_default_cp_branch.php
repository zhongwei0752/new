<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/cp_branch|template/default/header|template/default/cp_topic_menu|template/default/footer|template/default/space_topic_inc', '1370767047', 'template/default/cp_branch');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
