<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/cp_cases|template/default/header|template/default/cp_topic_menu|template/default/footer|template/default/space_topic_inc', '1375350856', 'template/default/cp_cases');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
...
<div class="content" style="font-size:15px;">
                 ...
                 <div class="indexing">
                 <span><a href="space.php?do=home">首页</a></span>><span><a href="space.php?do=introduce&view=me">成功案例</a></span>><span>发布</span>
                 </div><!-- end -->
