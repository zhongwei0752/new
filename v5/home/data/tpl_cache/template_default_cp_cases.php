<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/cp_cases|template/default/header|template/default/cp_topic_menu|template/default/footer|template/default/space_topic_inc', '1370768238', 'template/default/cp_cases');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
...
<div class="tabs_header">
<ul class="tabs">
<?php if($cases['casesid']) { ?>
<li class="active"><a href="cp.php?ac=cases&casesid=<?=$cases['casesid']?>"><span>编辑</span></a></li>
<?php } ?>
<li<?php if(empty($cases['casesid'])) { ?> class="active"<?php } ?>><a href="cp.php?ac=cases"><span>发布</span></a></li>
<li><a href="space.php?uid=<?=$space['uid']?>&do=cases&view=me"><span>成功案例</span></a></li>
</ul>
</div>
<?php } ?>
...
<tr>
<td>
标题：<input type="text" class="t_input" id="subject" name="subject" value="<?=$cases['subject']?>" size="60" onblur="relatekw();"  />
<br/>
案例甲方：<input type="text" class="t_input" size="82" id="company" name="company" value="<?=$cases['company']?>" > <br/>
封面图片:<input type="file" name="files" value="<?=$cases['image1url']?>"/>
</td>
</tr>
<tr>
<td>正文：
...
<textarea name="messagecomment" style="width:750px;height:200px;"><?=$cases['messagecomment']?></textarea>
</td>
</tr>
</table>
...
<th width="100">&nbsp;</th>
<td>
<input type="button" id="issuance" onclick="document.getElementById('casesbutton').click();" value="保存发布" class="submit" /></td>
</tr>
</table>
</div>
