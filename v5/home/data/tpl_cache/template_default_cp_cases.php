<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/cp_cases|template/default/header|template/default/cp_topic_menu|template/default/footer|template/default/space_topic_inc', '1373427624', 'template/default/cp_cases');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
...
<div class="content" style="font-size:15px;">
                 ...
                 <div class="indexing">
                   <img src="<?=$wei1['image2url']?>" /><span><?=$_SN[$space['uid']]?></span>><span>成功案例</span>
                 </div><!-- end -->
