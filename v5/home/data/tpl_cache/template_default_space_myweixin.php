<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_myweixin|template/default/header|template/default/footer', '1376561753', 'template/default/space_myweixin');?><?php $_TPL['titles'] = array($newname[subject]); ?>
...
<div class="content" style="font-size:15px;">
                 ...
                 <div class="indexing">
                 <span><a href="space.php?do=home">首页</a></span>><span>微信子账号(客服)</span>
                 </div><!-- end -->
                 <div class="bread container_12">
                     <div class="bread_actived grid_1">
                         微信子账号
                     </div>
                     <a href="cp.php?ac=myweixin" class="btn grid_2">
                      添加
                     </a>
                 </div>	
...
<?php if(is_array($list)) { foreach($list as $value) { ?>
                     <div class="content_list container_12">
                          <div class="grid_1">
                                <div class="list_pic"><?php echo avatar($value[uid],middle); ?></div>
                          </div>
                          <div class="grid_2" >
                             <div class="list_test ">
                                  <h3><?=$value['username']?></h3><br/>
                                  <p class="action_info" >
                                   <a href="space.php?uid=<?=$value['uid']?>"> <span>真实姓名：<?=$value['name']?></span><br/><span>负责内容：<?php $wei=$value['wei'] ?>
                                  <?php if(is_array($wei)) { foreach($wei as $value1) { ?>
                                  <?=$value1['subject']?>
                                  <?php } } ?></span></a><br/>
                                  <span>添加日期：<?php echo sgmdate('Y-m-d',$value[dateline]); ?></span>
                                  </p>
                             </div>
                          </div>
                     </div><!-- list end -->
                   ...
                   <?php } } ?>
<?php } else { ?>
<div class="c_form">还没有相关的微信子帐号。</div>
<?php } ?>
