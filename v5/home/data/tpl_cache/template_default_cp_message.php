<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/cp_message|template/default/header|template/default/cp_header|template/default/footer', '1370770341', 'template/default/cp_message');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
