<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_development_view|template/default/header|template/default/space_menu|template/default/space_comment_li|template/default/footer', '1373622365', 'template/default/space_development_view');?><?php $_TPL['titles'] = array($development['subject'], '企业动态'); ?>
