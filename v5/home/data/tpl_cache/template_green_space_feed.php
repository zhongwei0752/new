<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/green/space_feed|template/green/header|template/green/footer', '1373175019', 'template/green/space_feed');?><?php if(empty($_TPL['getmore'])) { ?>	
