<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_menuset_view|template/default/header|template/default/space_menu|template/default/space_click|template/default/space_comment_li|template/default/footer', '1370762603', 'template/default/space_menuset_view');?><?php $_TPL['titles'] = array($menuset['subject'], '应用'); ?>
...
<?php } ?>
<div id="content">
<?php if($menuset['money']) { ?>单价:<?=$menuset['money']?>元/月<?php } else { ?>单价:免费<?php } ?><br/>
<a href="cp.php?ac=menuset&menusetid=<?=$menuset['menusetid']?>&op=buy&money=<?=$menuset['money']?>" id="menuset_buy_<?=$menuset['menusetid']?>" onclick="ajaxmenu(event, this.id)">购买</a>
<div id="click_div">
