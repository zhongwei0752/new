...
<link rel="stylesheet" href="template/1/css/mobiscroll.custom-2.5.4.min.css" /> <!-- 插件所需 --> 
<script type="text/javascript" src="template/1/js/jquery-v2.0.2.js"></script> <!-- select插件要先load jQuery --> 
<script type="text/javascript" src="template/1/js/mobiscroll.custom-2.5.4.min.js"></script> <!-- 插件所需 --> 
<link rel="stylesheet" type="text/css" href="template/1/css/info.css" />
...
<div class="tag_menu">
<a href="#" id="show"><img src="template/1/img/tag_menu.png" alt="menu tag" id="tag_menu"
