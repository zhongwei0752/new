<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_industry_view|template/default/header|template/default/space_menu|template/default/space_comment_li|template/default/footer', '1375255908', 'template/default/space_industry_view');?><?php $_TPL['titles'] = array($industry['subject'], '行业动态'); ?>
...
<?php $_TPL['spacetitle'] = "行业动态";
	$_TPL['spacemenus'][] = "<a href=\"space.php?uid=$space[uid]&do=$do&view=me\">TA的所有行业动态</a>";
	$_TPL['spacemenus'][] = "<a href=\"space.php?uid=$space[uid]&do=industry&id=$industry[industryid]\">查看行业动态</a>"; ?>
...
<div style="padding:0 0 10px;">
            ...
            <div class="content" style="font-size:15px;">
                ...
                <span><a href="space.php?do=home">首页</a></span>><span><a href="space.php?do=industry&view=me">行业动态</a></span>
                 </div>
                 <div class="content_detail_wrapper">
                      <div class="content_page_detail">
                           <div class="content_title"><?=$industry['subject']?></div>
                           <div class="content_text_detail" style="text-align: center;margin-bottom:10px;margin-top:10px;font-size:12px;">作者 : <?=$industry['username']?>&nbsp;|&nbsp;发布时间 : <?php echo sgmdate('Y-m-d H:i:s',$industry[dateline]); ?></div>
