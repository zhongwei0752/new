<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/cp_poke|template/default/header|template/default/footer', '1374049223', 'template/default/cp_poke');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
