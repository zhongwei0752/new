<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_cases_list|template/default/header|template/default/footer', '1377685880', 'template/default/space_cases_list');?><?php $_TPL['titles'] = array($newname[subject]); ?>
                     ...
                     <div class="content_list container_12">
                          ...
                          <div class="grid_2">
                             <div class="list_test ">
                                  ...
                                  <p class="action_info"  style="margin-top:-4px;text-align:right;">
