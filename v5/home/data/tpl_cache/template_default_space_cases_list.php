<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_cases_list|template/default/header|template/default/footer', '1370768407', 'template/default/space_cases_list');?><?php $_TPL['titles'] = array('成功案例'); ?>
...
<ul class="tabs">
<li<?=$actives['me']?>><a href="space.php?uid=<?=$space['uid']?>&do=<?=$do?>&view=me"><span>成功案例</span></a></li>
<li class="null"  style="margin-left:670px;"><a href="cp.php?ac=cases">发布</a></li>
</ul>
</div>		
...
<h4><a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&id=<?=$value['casesid']?>" <?php if($value['magiccolor']) { ?> class="magiccolor<?=$value['magiccolor']?>"<?php } ?>><?=$value['subject']?></a></h4>
</div>	


<div class="detail image_right l_text" id="blog_article_<?=$value['casesid']?>">
<?php if($value['pic']) { ?><p class="image"><a href="space.php?uid=<?=$value['uid']?>&do=cases&id=<?=$value['casesid']?>"><img src="<?=$value['pic']?>" alt="<?=$value['subject']?>" /></a></p><?php } ?>
<?=$value['message']?>
</div>
<div class="gray">
...
<?php if($value['viewnum']) { ?><a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&id=<?=$value['casesid']?>">阅读: <?=$value['viewnum']?>次</a><span class="pipe">|</span><?php } else { ?>阅读: 0次<span class="pipe">|</span><?php } ?>
<?php if($value['replynum']) { ?><a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&id=<?=$value['casesid']?>#comment">评论: <?=$value['replynum']?> 个</a><?php } else { ?>评论: 0次<?php } ?>
</div>
</div>
</li>
<br/>
