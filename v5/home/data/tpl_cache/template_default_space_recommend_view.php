<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_recommend_view|template/default/header|template/default/space_menu|template/default/space_comment_li|template/default/footer', '1375082856', 'template/default/space_recommend_view');?><?php $_TPL['titles'] = array($recommend['subject'], '焦点推荐'); ?>
            	...
            	<div class="indexing" style="margin-bottom:15px;">
                 ...
                 <div class="content_detail_wrapper">
                      <div class="content_page_detail">
                           ...
                           <div class="content_text_detail" style="text-align: center;margin-bottom:10px;margin-top:10px;font-size:12px;">作者 : <?=$recommend['username']?>&nbsp;|&nbsp;发布时间 : <?php echo sgmdate('Y-m-d H:i:s',$recommend[dateline]); ?></div>
