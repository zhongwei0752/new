<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_introduce_list|template/default/header|template/default/footer', '1373351780', 'template/default/space_introduce_list');?><?php $_TPL['titles'] = array('企业介绍'); ?>
...
<div class="content" style="font-size:16px;">
                 ...
                 <div class="indexing">
                   <img src="<?=$wei1['image2url']?>" /><span><?=$_SN[$space['uid']]?></span>><span>企业介绍</span>
                 </div><!-- end -->
                             ...
                             <div class="list_test ">
                                  ...
                                  <p class="action_info">
                                   <a href="space.php?uid=<?=$value['uid']?>"> <span>发布：<?=$_SN[$value['uid']]?></span></a>
                                    ...
                                    <?php if($value['replynum']) { ?><a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&id=<?=$value['introduceid']?>#comment"><span>评论: <?=$value['replynum']?> 个</span></a><?php } else { ?><span>评论: 0次</span><?php } ?>
                                  </p>
                             </div>
                          </div>
                     </div><!-- list end -->
