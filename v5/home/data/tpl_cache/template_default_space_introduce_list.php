<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_introduce_list|template/default/header|template/default/footer', '1370763836', 'template/default/space_introduce_list');?><?php $_TPL['titles'] = array('企业介绍'); ?>
...
<?php } else { ?>
<div class="c_form">还没有相关的企业介绍。</div>
<?php } ?>
</div>
<?php } else { ?>
...
<ul class="tabs">
<li<?=$actives['me']?>><a href="space.php?uid=<?=$space['uid']?>&do=<?=$do?>&view=me"><span>企业介绍</span></a></li>
<li class="null" style="margin-left:670px;"><a href="cp.php?ac=introduce">发布</a></li>
</ul>
</div>		
...
<h4><a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&id=<?=$value['introduceid']?>" <?php if($value['magiccolor']) { ?> class="magiccolor<?=$value['magiccolor']?>"<?php } ?>><?=$value['subject']?></a></h4>
</div>	


<div class="detail image_right l_text" id="blog_article_<?=$value['introduceid']?>">
<?php if($value['pic']) { ?><p class="image"><a href="space.php?uid=<?=$value['uid']?>&do=introduce&id=<?=$value['introduceid']?>"><img src="<?=$value['pic']?>" alt="<?=$value['subject']?>" /></a></p><?php } ?>
<?=$value['message']?>
</div>
<div class="gray">
...
<?php if($value['viewnum']) { ?><a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&id=<?=$value['introduceid']?>">阅读: <?=$value['viewnum']?>次</a><span class="pipe">|</span><?php } else { ?>阅读: 0次<span class="pipe">|</span><?php } ?>
<?php if($value['replynum']) { ?><a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&id=<?=$value['introduceid']?>#comment">评论: <?=$value['replynum']?> 个</a><?php } else { ?>评论: 0次<?php } ?>
</div>
</div>
</li>
<br/>
