<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('./wx/template/feedcontent', '1374176861', './wx/template/feedcontent');?><!DOCTYPE html>
<html>
  <head>
  	 <title></title>
  	 <meta charset="utf-8">
        ...
        <div>
          <div class="normal_wrapper_width">
           <div class="content_pic">
                <img src="../attachment/{{= introduce.pic}}">
             </div>
       ...
       <div id="detail-panel">
          ...
          <div style="background:#f0f0f0">
             <div class="normal_wrapper_width container_12">
                ...
                <a  class="comment_btn grid_3" onclick="cpComment($('#idtype').val(), $('#id').val(), $('#review').val())">
                   发表
                </a>
            </div>
