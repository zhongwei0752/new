<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('./wx/template/feedcontent', '1374138101', './wx/template/feedcontent');?><!DOCTYPE html>
<html>
  <head>
  	 <title></title>
  	 <meta charset="utf-8">
 ...
 <header class="content_header_width">
            <h3>{{= introduce.subject}}</h3>
            <span class="time">{{= introduce.dateline}}</span>
        </header><!-- header end -->
        <div>
          ...
          <div style="background:#f0f0f0">
             <div class="normal_wrapper_width container_12">
                <div class="comment_wrapper grid_8">
                   <textarea placeholder="写下你的评论..." class="comment_text_box"></textarea>
                </div>
                <a href="#" class="comment_btn grid_3">
                   发表
                </a>
            </div>
            <div class="split"></div><!-- 这个是分割线 -->
            <div class="normal_wrapper_width comments"><span class="commenter">CT626:</span> 美丽人的衣服很好看啊~而且这个品牌很有内涵的说~</div>

             <div class="split"></div><!-- 这个是分割线 -->
            <div class="normal_wrapper_width comments"><span class="commenter">游虾: </span> 喜欢美丽人生~</div>

             <div class="split"></div><!-- 这个是分割线 -->
            <div class="normal_wrapper_width comments"><span class="commenter">天降之屎: </span> 美丽人生很垃圾很垃圾~</div>
